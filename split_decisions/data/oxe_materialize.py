...
from prismatic.vla.datasets.rlds.oxe.configs import ActionEncoding
from prismatic.vla.datasets.rlds.utils.data_utils import NormalizationType, tree_map
from .oxe_configs import NEW_OXE_DATASET_CONFIGS
from .oxe_transforms import NEW_OXE_STANDARDIZATION_TRANSFORMS
...
def make_oxe_dataset_kwargs(
    ...
    dataset_kwargs = deepcopy(NEW_OXE_DATASET_CONFIGS[dataset_name])
    ...
    dataset_kwargs["standardize_fn"] = NEW_OXE_STANDARDIZATION_TRANSFORMS[dataset_name]
